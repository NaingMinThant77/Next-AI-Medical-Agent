    ...
    <div className="bg-card/80 backdrop-blur-lg rounded-3xl shadow-xl border border-border p-6">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="bg-primary/10 rounded-2xl p-4 text-center">
          ...
          <p className="text-sm text-muted-foreground">Free Specialists</p>
        </div>
        <div className="bg-purple-100/30 rounded-2xl p-4 text-center">
          <div className="text-2xl font-bold text-purple-600 mb-1">
            {AIDoctorAgents.filter((d) => d.subscriptionRequired).length}
          </div>
          <p className="text-sm text-muted-foreground">Premium Specialists</p>
        </div>
        <div className="bg-green-100/30 rounded-2xl p-4 text-center">
      ...
      {/* Footer Info */}
      <div className="mt-6 p-4 bg-gradient-to-r from-primary/10 to-purple-50 dark:bg-gradient-to-br darK:from-blue-900 dark:via-black dark:to-blue-800 rounded-2xl">
